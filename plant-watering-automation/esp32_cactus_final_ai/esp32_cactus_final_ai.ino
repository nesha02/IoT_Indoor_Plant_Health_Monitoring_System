...
// ===============================================
// CACTUS DEMO MODE - SMART TINYML IRRIGATION SYSTEM
// ===============================================
...
// ---------------- THRESHOLDS ----------------
#define START_LEVEL 20     // start watering below this
#define STOP_LEVEL 28      // normal stop target
#define HARD_MAX   35      // emergency upper stop
...
void setup() {
  ...
  Serial.println("==================================");
  Serial.println("Cactus DEMO AI System Ready");
